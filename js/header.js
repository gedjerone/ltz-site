class Header {
    ...
    render(html_time, price, weight) {
        ...
        <div class="navbar">
            ...
            <ul class="menu">
                <li><a href="/index" id="index">ГЛАВНАЯ</a></li>
                <li><a href="/products_photo" id="products_photo">ПРОДУКЦИЯ</a></li>
                <li><a href="/products" id="products">ПРАЙС-ЛИСТЫ</a></li>
                <li><a href="/shipping" id="shipping">ДОСТАВКА</a></li>
            ...
            <ul class="menu_nav">
                <ul class="menu_1">
                    <li id="menu_1-1"><a href="/index" id="index">ГЛАВНАЯ</a></li>
                    <li id="menu_1-2"><a href="/contacts" id="contacts">КОНТАКТЫ</a></li>
                    <li id="menu_1-3"><a href="/shipping" id="shipping">ДОСТАВКА</a></li>
                </ul>
                <ul class="menu_2">
                    <li id="menu_2-1"><a href="/products_photo" id="products">ПРОДУКЦИЯ</a></li>
                    <li id="menu_2-2"><a href="/products" id="shipping">ПРАЙС-ЛИСТЫ</a></li>
                </ul>
                <ul class="menu_3">
                    <li class="cart_li">
                        <a href="/cart" id="cart">
